...
@min_players 10
  ...
  defstruct players: [], status: :waiting_for_players, current_deck: nil, original_deck: nil, bet: 0, pot: 0, rules: %{small_blind: 10, big_blind: 20, ante: 0, buy_in: 5, min_players: 2, max_players: 2}, type: "texas holdem", turn: nil
