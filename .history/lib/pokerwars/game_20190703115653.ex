defmodule Pokerwars.Game do
  ...
  defstruct players: [], status: :waiting_for_players, current_deck: nil, original_deck: nil, rules: %{small_blind: 10, big_blind: 20, min_players: 2, max_players: 2}, type: "texas holdem"
  ...
  when length(players) < rules.max_players do
